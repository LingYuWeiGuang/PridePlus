...
import op.wawa.prideplus.utils.object.Location;
import op.wawa.prideplus.utils.object.Rotation;
import op.wawa.prideplus.utils.vec.Vector2f;
...
import op.wawa.prideplus.utils.vec.Vector3d;
...
public class RotationUtils implements MinecraftInstance {
    ...
    public static Rotation calculate(final Vector3d position, final EnumFacing enumFacing) {
    ...
    public static Rotation VtargetRotations;
    ...
    public static float[] getCustomSmoothRotations(EntityLivingBase entity, float maxspeed, float minspeed) {
        ...
        yaw = smoothRotation(mc.thePlayer.prevRotationYawHead, yaw, (float) (fac * MathUtils.getRandom(maxspeed, minspeed)));
        pitch = smoothRotation(mc.thePlayer.prevRotationPitchHead, pitch, (float) (fac * MathUtils.getRandom(maxspeed, minspeed)));
        return new float[]{yaw, pitch};
    }
    ...
    public static double getRotationDifference(final Rotation rotation) {
        return RotationManager.lastServerRotation == null ? 0D : getRotationDifference(rotation, RotationManager.lastServerRotation);
    }
    ...
    public static Rotation getRotationFromEyeToPoint(javax.vecmath.Vector3d point3d) {
        return getRotation(new javax.vecmath.Vector3d(mc.thePlayer.posX, mc.thePlayer.getEntityBoundingBox().minY + mc.thePlayer.getEyeHeight(), mc.thePlayer.posZ), point3d);
    }
    ...
    public static Rotation getRotation(javax.vecmath.Vector3d from, javax.vecmath.Vector3d to) {
    ...
    public static float[] getRotations(Entity entity) {
        ...
        if (entity instanceof EntityLivingBase) {
            diffY = entity.posY + (entity.getEyeHeight()) - (mc.thePlayer.posY + mc.thePlayer.getEyeHeight());
        } else {
    ...
    public static float[] getSmoothRotations(EntityLivingBase entity) {
        ...
        float yaw = (float) (MathHelper.atan2(z, x) * 180.0 / Math.PI) - 90.0F;
        float pitch = (float) (-(MathHelper.atan2(y, d3) * 180.0 / Math.PI));
        yaw = smoothRotation(mc.thePlayer.prevRotationYawHead, yaw, (float) (fac * MathUtils.getRandom(0.9F, 1)));
        pitch = smoothRotation(mc.thePlayer.prevRotationPitchHead, pitch, (float) (fac * MathUtils.getRandom(0.7F, 1)));
