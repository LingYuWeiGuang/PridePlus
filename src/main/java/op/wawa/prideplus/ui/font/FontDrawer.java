...
import op.wawa.prideplus.utils.render.GLUtils;
...
public final class FontDrawer extends FontRenderer implements MinecraftInstance {
    ...
    public String trimStringToWidth(String text, int width) {
        return this.trimStringToWidth(text, (float) width);
    }

    @Override
    public String trimStringToWidth(String text, int width, boolean reverse) {
        return this.trimStringToWidth(text, (float) width, reverse);
    }
    ...
    public void drawCenteredStringWithShadow(String s, double x, double y, int color) {
        drawStringWithShadow(s, x - (getStringWidth(s) / 2.0), y - getHeight() / 2.0, color);
    }

    public void drawCenteredString(String s, double x, double y, int color) {
        drawString(s, x - getStringWidth(s) / 2.0, y - getHeight() / 2.0, color);
    }

    public void drawCenteredStringWithShadow2(String s, double x, double y, int color) {
        drawStringWithShadow(s, x - (getStringWidth(s) / 2.0), y, color);
    }

    public void drawCenteredString2(String s, double x, double y, int color) {
    ...
    public void drawStringWithOutline(String s, double x, double y, int color) {
        final String s1 = EnumChatFormatting.getTextWithoutFormattingCodes(s);

        drawStringDirectly(s1, x + 0.5, y, 0);
        drawStringDirectly(s1, x - 0.5, y, 0);
        drawStringDirectly(s1, x, y + 0.5, 0);
        drawStringDirectly(s1, x, y - 0.5, 0);
    ...
    public int drawStringWithShadow(String text, float x, float y, int color) {
        this.drawStringWithShadow(text, (double) x, (double) y, color);
        return 0;
    }
    ...
    public int drawString(String text, int x, int y, int color) {
        this.drawString(text, (double) x, (double) y, color);
        return 0;
    }

    @Override
    public int drawString(String text, float x, float y, int color, boolean dropShadow) {
        this.drawString(text, (double) x, (double) y, color, dropShadow);
        return 0;
    }
