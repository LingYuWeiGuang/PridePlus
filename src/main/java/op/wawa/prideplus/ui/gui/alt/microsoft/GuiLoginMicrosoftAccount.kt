package op.wawa.prideplus.ui.gui.alt.microsoft
...
abstract class GuiLoginMicrosoftAccount(private val parentScreen : GuiScreen) : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        FontManager.default16.drawCenteredStringWithShadow2(status,width / 2.0,height / 2.0 - FontManager.default16.height,-1)
    }
