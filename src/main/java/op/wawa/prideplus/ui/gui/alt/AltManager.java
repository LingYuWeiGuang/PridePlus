...
public final class AltManager {
    ...
    private final File ALT_FILE = new File(Pride.INSTANCE.configManager.getClientDirectory(), "alts.json");
    @Getter
    ...
    public static LoginStatus loginAlt(String account, String password) throws AuthenticationException {
        if (StringUtils.isNullOrEmpty(password)) {
            Minecraft.getMinecraft().setSession(new Session(account, "", "", "mojang"));
