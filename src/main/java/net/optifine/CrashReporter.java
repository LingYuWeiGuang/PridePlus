...
public class CrashReporter
{
    ...
    private static String makeReport(CrashReport crashReport)
    {
        ...
        stringbuffer.append("OptiNotFineVersion: " + Config.getVersion() + "\n");
    ...
    {
        cat.addCrashSection("OptiNotFine Version", Config.getVersion());
        cat.addCrashSection("OptiNotFine Build", Config.getBuild());
