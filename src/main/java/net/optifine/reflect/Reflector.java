...
public class Reflector
{
    ...
    public static ReflectorClass GuiMainMenu = new ReflectorClass(op.wawa.prideplus.ui.gui.GuiMainMenu.class);
    ...
    private static boolean registerResolvable(final String str)
    {
        IResolvable iresolvable = new IResolvable()
        {
            public void resolve()
            {
                Reflector.LOGGER.info("[OptiNotFine] " + str);
            }
        };
