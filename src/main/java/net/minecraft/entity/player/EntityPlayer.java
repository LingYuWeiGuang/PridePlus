...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    {
        super.jump();
        float f = ViaLoadingBase.getInstance().getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_8) ? 0.8F : 0.2F;
        float f2 = ViaLoadingBase.getInstance().getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_8) ? 0.2F : 0.05F;
