...
import op.wawa.prideplus.event.events.EventSafeWalk;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            Pride.INSTANCE.eventManager.call(safeWalkEvent);
    ...
    public void moveFlying(float strafe, float forward, float friction)
    {
        ...
        if (this instanceof EntityPlayer) {
            ...
            Pride.INSTANCE.eventManager.call(eventStrafe);
    ...
    public float getClosestDistanceToEntity(Entity entityIn) {
        ...
        Vec3 pos = RotationUtils.getNearestPointBB(eyes, entityIn.getEntityBoundingBox());
    ...
    public MovingObjectPosition rayTrace(double blockReachDistance, float partialTicks, Rotation rotation) {
        Vec3 vec3 = this.getPositionEyes(partialTicks);
        Vec3 vec31 = this.getLook(rotation);
        Vec3 vec32 = vec3.addVector(vec31.xCoord * blockReachDistance, vec31.yCoord * blockReachDistance, vec31.zCoord * blockReachDistance);
        return this.worldObj.rayTraceBlocks(vec3, vec32, false, false, true);
    }
