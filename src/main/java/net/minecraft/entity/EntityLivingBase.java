...
import op.wawa.prideplus.event.events.EventJump;
...
public abstract class EntityLivingBase extends Entity
{
    ...
    protected void jump()
    {
        if (this instanceof EntityPlayerSP) {
            EventJump jumpEvent = new EventJump(this.getJumpUpwardsMotion(), this.movementYaw);
            Pride.INSTANCE.eventManager.call(jumpEvent);

            this.movementYaw = jumpEvent.getYaw();
            this.motionY = jumpEvent.getMotion();
        } else this.motionY = this.getJumpUpwardsMotion();
    ...
    public void onLivingUpdate()
    {
        ...
        double minimumMotion = ViaLoadingBase.getInstance().getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_8) ? 0.005D : 0.003D;
