...
public class Config
{
    ...
    public static final String VERSION = "OptiNotFine_1.8.9";
    ...
    public static String getVersionDebug()
    {
        ...
        stringbuffer.append("OptiNotFine_1.8.9");
    ...
    public static void detail(String p_detail_0_)
    {
        if (logDetail)
        {
            LOGGER.info("[OptiNotFine] " + p_detail_0_);
        }
    }

    public static void dbg(String p_dbg_0_)
    {
        LOGGER.info("[OptiNotFine] " + p_dbg_0_);
    }

    public static void warn(String p_warn_0_)
    {
        LOGGER.warn("[OptiNotFine] " + p_warn_0_);
    }

    public static void error(String p_error_0_)
    {
        LOGGER.error("[OptiNotFine] " + p_error_0_);
    }
