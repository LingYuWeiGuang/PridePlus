...
import op.wawa.prideplus.event.events.EventPlace;
import op.wawa.prideplus.event.events.EventTick;
import op.wawa.prideplus.ui.font.FontManager;
import op.wawa.prideplus.ui.gui.GuiMainMenu;
import op.wawa.prideplus.ui.gui.GuiPostProcessing;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame()
    {
        ...
        Pride.INSTANCE.startClient();

        this.displayGuiScreen(new GuiPostProcessing());
    ...
    public void runTick() throws IOException
    {
        if (this.thePlayer != null) {
            thePlayer.movementYaw = thePlayer.rotationYaw;
            Pride.INSTANCE.eventManager.call(new EventTick());
        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        Pride.INSTANCE.moduleManager.onKey(k);
            ...
            Pride.INSTANCE.eventManager.call(eventClick);
