    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 1:
                ...
                if (flag)
                {
                    this.mc.displayGuiScreen(new op.wawa.prideplus.ui.gui.GuiMainMenu());
                }
                else if (flag1)
                {
                    RealmsBridge realmsbridge = new RealmsBridge();
                    realmsbridge.switchToRealms(new op.wawa.prideplus.ui.gui.GuiMainMenu());
                }
                else
                {
                    this.mc.displayGuiScreen(new GuiMultiplayer(new op.wawa.prideplus.ui.gui.GuiMainMenu()));
                }
