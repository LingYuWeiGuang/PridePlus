...
// -- Begin LWJGL2 part --
    ...
    public static void glVertexAttribPointer(int index, int size,
        ...
        GL20.nglVertexAttribPointer(index, size, unsigned ? GL_UNSIGNED_SHORT : GL_SHORT, normalized, stride, MemoryUtil.memAddress(buffer));
    }

    public static void glVertexAttribPointer(int index, int size,
                                             boolean unsigned, boolean normalized,
                                             int stride, IntBuffer buffer) {
        GL20.nglVertexAttribPointer(index, size, unsigned ? GL_UNSIGNED_INT : GL_INT, normalized, stride, MemoryUtil.memAddress(buffer));
    }
